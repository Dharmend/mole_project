...
<div id="footer">
  ...
  <section class="wrapper carousel-wrapper" style="border:10px solid lightgrey; background-color:white;">
	...
	<ul class="slides" style="width: 1200%; transition-duration: 0.6s; transform: translate3d(0px, 0px, 0px);">
          ...
          </ul></div><ol class="flex-control-nav flex-control-paging"><li>
		  <a class="flex-active">1</a></li><li><a class="">2</a></li></ol><ul class="flex-direction-nav"><li class="flex-nav-prev">
		  <a href="#" class="flex-prev flex-disabled" tabindex="-1">Previous</a></li><li class="flex-nav-next"><a href="#" class="flex-next" tabindex="-1">Next</a></li></ul></div>
    </div>
</section>
